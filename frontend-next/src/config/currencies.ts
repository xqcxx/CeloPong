...
export const FEE_CURRENCIES = {
  CELO: { symbol: 'CELO', address: null as string | null, adapter: null as string | null },
...
export function getCurrencyByKey(key: string): CurrencyConfig | null {
  return CURRENCIES[key] || null;
}

export function isNativeToken(tokenAddress: string | null): boolean {
